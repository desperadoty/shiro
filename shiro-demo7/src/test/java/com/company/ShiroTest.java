...
import com.company.realm.UserRealm;
...
@ContextConfiguration(locations = {"classpath:spring-config.xml","classpath:spring-shiro.xml"})
public class ShiroTest {
    ...
    @Autowired
    private void setDataSource(DataSource ds) { jdbcTemplate = new JdbcTemplate(ds);}
