...
public class CodecAndCryptoTest {
    ...
    public void testRandom() {
        ...
        //23ae809ddacaf96af0fd78ed04b6a265
    ...
    public void testMd5() {
        ...
        System.out.println(new Md5Hash(str, salt).toBase64());
        System.out.println(new Md5Hash(str, salt).toHex());
    }
    ...
    public void testHashService() {
        ...
        hashService.setGeneratePublicSalt(true); //是否生成公盐，默认为false
    ...
    public void testBlowfishCipherService() {
        ...
        blowfishCipherService.setKeySize(128); //设置key长度
